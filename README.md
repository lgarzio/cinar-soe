...
Synthesized datasets that contain bottom- and surface-water pH and aragonite saturation state from glider- and vessel-based data sources can be found [here](https://marine.rutgers.edu/~lgarzio/cinar_soe/2025_submission/data_files/). Code used to generated the synthesized vessel-based [bottom](https://github.com/lgarzio/cinar-soe/blob/master/analysis2026/data_wrangler_bottom_vessel.py) and [surface](https://github.com/lgarzio/cinar-soe/blob/master/analysis2026/data_wrangler_surface_vessel.py) datasets and [glider-based datasets]https://github.com/lgarzio/cinar-soe/blob/master/analysis2026/data_wrangler_bottom_surface_glider.py).

## Satellite-derived data
Satellite-derived chlorophyll and sea surface temperature data files were [downloaded](https://github.com/lgarzio/cinar-soe/blob/master/download_nasa_data_calc_monthly_avg.py) from the NASA Ocean Biology Distributed Active Archive Center (OB.DAAC) [OPENDAP server](https://oceandata.sci.gsfc.nasa.gov/opendap/). These data can also be downloaded using the [Level 3 & 4 Browser](https://oceancolor.gsfc.nasa.gov/l3/) with the following selections:
